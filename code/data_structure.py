...
class vehicle(object):
    ...
    def calculate_distance(self):
        '''Computes and sets the distance of this vehicle'''
        result = 0
    ...
    def calculate_load(self):
        '''Computes and sets the load of this vehicle'''
        self.load = sum([c.demand for c in self.route])
        
    def create_deliveries(self, first_deliveries = []):
        '''For the customers given in the self.route, we create deliveries linking the customer to the vehicle. 
        Deliveries are set in self.deliveries. 
        If the set of deliveries is partly known already, it is possible to input some deliveries, then only the missing ones are computed'''
    ...
    def get_delivery(self, customer):
        '''returns the delivery for the given customer and this vehicle'''
    ...
    def calc_vehicle_centroid(self):
        ''' Returns the coordinate consisting of the average x and average y coordinate of all customers in the route. 
        In case there is no customer in the route, it returns the depot location. '''
...
class instance(object):
    ...
    def calculate_distances(self):
        '''calculates the distances between customers and sets the corresponding variables'''
    ...
    def customer_by_nr(self, customer_nr):
        '''Return a customer by its customer number'''
...
class solution(object):
    ...
    def from_vroom_json_file(cls, instance, filename):
        try: 
            ...
            print(f"Unable to find initial solution for instance {instance.name} in location: ", filename,  f"\n{e}" )
    ...
    def find_vehicle(self, cus):
        ''' Return the vehicle in the solution for the given customer'''
    ...
    def find_delivery(self, customer):
        '''Return the delivery in the solution for the given customer'''
    ...
    def get_distance_contribution(self, customer):
        '''Return the distance contribution for this customer in the solution'''
        if customer == self.instance.depot:
    ...
    def get_total_cost_contribution(self, customer):
        '''Return the distance + time window contribution for this customer in the solution'''
    ...
    def get_average_route_distance(self, customer):
        '''Return the average route distance for the vehicle that the customer is in'''
        if customer == self.instance.depot:
